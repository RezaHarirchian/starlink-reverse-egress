# 🌐 اتصال VPS ایران به اینترنت آزاد در حالت Shutdown
...
نه اختلال، نه محدودسازی، نه فیلترینگ اما از آیپی خارجی قابل دسترس باشد.
...
* در صورتی که این سناریو به علت مسدودی ارتباط دو طرفه انجام نشد نیاز است سرور ایران به صورت فیزیکی به استارلینک متصل شود و مراحل مذکور طی شود
