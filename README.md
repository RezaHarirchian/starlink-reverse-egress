...
## معماری مهندسی‌شده، پایدار و قابل Scale برای بار کاربری بالا
...
- [🔑 مرحله ۱ – تانل معکوس با WireGuard](#-مرحله-۱--هسته-معماری-تانل-معکوس-با-wireguard)
- [👥 مرحله ۲ – روش‌های اتصال کاربر](#-مرحله-۲--روشهای-اتصال-کاربر-client-access)
- [⚖️ مرحله ۳ – Load Balance](#-مرحله-۳--load-balance-و-scale-out-architecture)
- [⚡ مرحله ۴ – Failover](#-مرحله-۴--failover)
- [📊 مرحله ۵ – Monitoring](#-مرحله-۵--monitoring)
...
* در شرایط Shutdown واقعی قابل اجراست
